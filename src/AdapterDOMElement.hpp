...
//
class AdapterDOMElement : public virtual XERCES::DOMElement, public AdapterDOMNode
{
protected:
private:
    dom::Element* _node;
public:
    AdapterDOMElement();
    AdapterDOMElement(dom::Element* node) : _node(node), AdapterDOMNode(node) {}
    virtual ~AdapterDOMElement() {}
