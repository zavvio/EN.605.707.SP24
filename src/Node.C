...
dom::NodeList* Composite_Impl::getChildNodes(void)
{
	return &nodes;
}

dom::Node* Composite_Impl::getFirstChild(void)
{
	return *nodes.begin();
}

dom::Node* Composite_Impl::getLastChild(void)
{
	return *(--nodes.end());
}

dom::Node* Composite_Impl::insertBefore(dom::Node* newChild, dom::Node* refChild)
{
...
dom::Node* Composite_Impl::replaceChild(dom::Node* newChild, dom::Node* oldChild)
{
	if (newChild->getOwnerDocument() != getOwnerDocument())
		throw dom::DOMException(dom::DOMException::WRONG_DOCUMENT_ERR, "New Child is not a part of this document.");
...
dom::Node* Composite_Impl::removeChild(dom::Node* oldChild)
{
	dom::NodeList::iterator	index = nodes.find(oldChild);
...
dom::Node* Composite_Impl::appendChild(dom::Node* newChild)
{
	if (newChild->getOwnerDocument() != getOwnerDocument())
		throw dom::DOMException(dom::DOMException::WRONG_DOCUMENT_ERR, "New Child is not a part of this document.");
...
bool Composite_Impl::hasChildNodes(void)
{
	return nodes.size() > 0;
}